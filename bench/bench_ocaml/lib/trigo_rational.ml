    ...
    [
      ...
      ( (zero, pi_half),
        [
          Rational.
            {
              p = Z.of_string "6021947012555463";
              q = Z.of_string "10000000000000000";
            };
          {
            p = Z.of_string "513625166679107";
            q = Z.of_string "1000000000000000";
          };
          {
            p = Z.of_string "-10354634426296383";
            q = Z.of_string "100000000000000000";
          };
          {
            p = Z.of_string "-13732034234358675";
            q = Z.of_string "1000000000000000000";
          };
          {
            p = Z.of_string "13586698380902013";
            q = Z.of_string "10000000000000000000";
          };
          {
            p = Z.of_string "10726309440570181";
            q = Z.of_string "100000000000000000000";
          };
          {
            p = Z.of_string "-7046296793891682";
            q = Z.of_string "1000000000000000000000";
          };
          {
            p = Z.of_string "-3963902510811801";
            q = Z.of_string "10000000000000000000000";
          };
          {
            p = Z.of_string "194995972671759";
            q = Z.of_string "10000000000000000000000";
          };
          {
            p = Z.of_string "8522923894416223";
            q = Z.of_string "10000000000000000000000000";
          };
          {
            p = Z.of_string "-3351717514643582";
            q = Z.of_string "100000000000000000000000000";
          };
          {
            p = Z.of_string "-11987008607938776";
            q = Z.of_string "10000000000000000000000000000";
          };
          {
            p = Z.of_string "3835820550079916";
